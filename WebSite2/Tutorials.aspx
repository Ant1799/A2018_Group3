...
<html lang="en">
    ...
    <body>		
		...
		<div class="container">
			<div class="row">			    
				<div class="span4">
						<input type="text" class="input-block-level search-query" Placeholder="eg. Bread"><br /><br />
                    <asp:Button ID="Button10" class="btn btn-inverse" runat="server" Text="Back" OnClick="Button8_Click"/>
				</div>
				<div class="span8">
		...
		<div  class="container">
			...
			<img class="pageBanner" src="themes1/images/cakes/banner1.jpg" alt="New products" >
