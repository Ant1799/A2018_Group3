		...
		<div id="wrapper" class="container">
			...
			<section  class="homepage-slider" id="home-slider">
				<div class="flexslider">
					<ul class="slides">
						<li>
							<img src="themes1/images/carousel/banner-1.jpg" alt="" />
						</li>
						<li>
							<img src="themes1/images/carousel/banner-2.jpg" alt="" />
							<div class="intro">
											...
											<ul class="thumbnails">												
												<li class="span3">
													<div class="product-box">
                                                        ...
                                                        <asp:Button ID="Button1" runat="server" Text="Check Now!" OnClick="Button1_Click" />
													</div>
												</li>
												<li class="span3">
													<div class="product-box">
